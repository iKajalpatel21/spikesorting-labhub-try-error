...
export default function CreateSortingJobWizard({ onBack }) {
  ...
  const fetchPipelines = async () => {
    try {
      ...
      const mockPipelines = [
        { id: 1, name: 'Standard Pipeline', description: 'Basic spike sorting', steps_count: 5 },
        { id: 2, name: 'Advanced Pipeline', description: 'Advanced spike sorting with curation', steps_count: 8 },
      ];
      setAvailablePipelines(mockPipelines);
    } catch (error) {
